...
const learningItems = [
  ...
  { title: 'Aulas/Mentorias', url: '/aulas', icon: GraduationCap },
];
  ...
  return (
    <Sidebar collapsible="icon" className="border-r-0">
        ...
        <div className="flex items-center gap-3">
          ...
          {!isCollapsed && (
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-sidebar-foreground">SOPP</span>
              <span className="text-xs text-sidebar-foreground/60">Sistema Operacional</span>
            </div>
          )}
        </div>
      </SidebarHeader>
      ...
      <SidebarContent className="scrollbar-thin">
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="text-sidebar-foreground/50">Aprendizado</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="text-sidebar-foreground/50">Finanças</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
      ...
      <SidebarFooter className="border-t border-sidebar-border p-2">
        ...
        <SidebarTrigger className="mt-2 w-full justify-center text-sidebar-foreground/60 hover:text-sidebar-foreground" />
      </SidebarFooter>
    </Sidebar>
  );
}
